...
> Перед очисткой закройте браузеры, Discord, приложения Adobe и выбранные игровые лаунчеры. Файлы, которые сейчас использует Windows или другая программа, будут безопасно пропущены.
...
В центре восстановления показываются исходный и сжатый размеры. Один бэкап можно восстановить, а несколько старых копий — выбрать и быстро удалить. После очистки приложение напоминает, что новый бэкап продолжает занимать место на диске.
